...
HeaderLineTypeValues header_line_types[] =
{
    ...
    ENUM_VALUE(CONT_NAME_LINE, 7),
    ENUM_VALUE(CONT_DISP_LINE, 8),
    ENUM_VALUE(CONT_LEN_LINE, 9),
    ENUM_VALUE(CONT_XFER_LINE, 10),
    ENUM_VALUE(CONT_TYPE_LINE, 11),
    ENUM_VALUE(DIST_LINE, 12),
    ENUM_VALUE(DATE_LINE, 13),
    ENUM_VALUE(EXPIR_LINE, 14),
    ENUM_VALUE(FOLLOW_LINE, 15),
    ENUM_VALUE(FROM_LINE, 16),
    ENUM_VALUE(IN_REPLY_LINE, 17),
    ENUM_VALUE(KEYW_LINE, 18),
    ENUM_VALUE(LINES_LINE, 19),
    ENUM_VALUE(MIME_VER_LINE, 20),
    ENUM_VALUE(MSG_ID_LINE, 21),
...
ObjectNumberValues object_numbers[] =
{
    ...
    ENUM_VALUE(COLOR_ART_LINE1, 15),
    ENUM_VALUE(COLOR_MIME_SEP, 16),
    ENUM_VALUE(COLOR_MIME_DESC, 17),
    ENUM_VALUE(COLOR_CITE_DTEXT, 18),
    ENUM_VALUE(COLOR_BODY_TEXT, 19),

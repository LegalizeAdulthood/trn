...
function(configure_trn_test_data)
    ...
    set(TRN_TEST_HEADER_NOTES_FILE_SUBJECT "${TRN_TEST_HEADER_ONE_RE_SUBJECT} - (nf)")
    ...
    set(TRN_TEST_ARTICLE_NOTES_FILE_SUBJECT_NUM 626)

    # Active file contents.
    set(TRN_TEST_NEWSGROUP_HIGH "${TRN_TEST_ARTICLE_NOTES_FILE_SUBJECT_NUM}")
    ...
    set(TRN_TEST_LOCAL_NEWSRC_FILE          "${TRN_TEST_DOT_DIR}/local-newsrc")
    set(TRN_TEST_ACCESS_LOCAL_NEWSRC        "%{TMPDIR}/local-newsrc")
    ...
    set(TRN_TEST_NNTP_NEWSRC_FILE           "${TRN_TEST_DOT_DIR}/nntp-newsrc")
    set(TRN_TEST_ACCESS_NNTP_NEWSRC         "%{TMPDIR}/nntp-newsrc")
    ...
    configure_file(cmake/test_article_notes_file_subject.in "${TRN_TEST_NEWSGROUP_DIR}/${TRN_TEST_ARTICLE_NOTES_FILE_SUBJECT_NUM}")
    ...
    configure_file(cmake/test_nntp_newsrc.in            "${TRN_TEST_NNTP_NEWSRC_FILE}")

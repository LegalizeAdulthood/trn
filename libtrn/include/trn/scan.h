...
struct ScanContext
{
    ...
    short item_num_cols; /* characters for item number column */
...
extern short g_s_item_num_cols; /* characters for item number column */

...
1. `libtrn/scorefile.cpp`, `sf_get_extra_header`
...
2. `libtrn/search.cpp`, `CompiledRegex::compile`
...
3. `libtrn/util.cpp`, `secs_to_text`
...
4. `libtrn/cache.cpp`, `fetch_cache`
...
5. `libtrn/head.cpp`, `prefetch_lines`

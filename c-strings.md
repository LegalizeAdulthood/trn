...
1. `libtrn/kfile.cpp`, `kill_file_init`
...
2. `libtrn/kfile.cpp`, `do_kill_file`
...
3. `libtrn/kfile.cpp`, `edit_kill_file`
...
4. `libtrn/scorefile.cpp`, `sf_get_extra_header`
...
5. `libtrn/search.cpp`, `CompiledRegex::compile`
...
6. `libtrn/util.cpp`, `secs_to_text`
...
7. `libtrn/cache.cpp`, `fetch_cache`
...
8. `libtrn/head.cpp`, `prefetch_lines`

...
1. `libtrn/charsubst.cpp`, `current_char_subst`
...
2. `libtrn/rt-page.cpp`, `display_option`
...
3. `libtrn/mime.cpp`, `mime_types_match`
...
7. `libtrn/ngsrch.cpp`, `newsgroup_comp`
...
8. `libtrn/autosub.cpp`, `match_list`
...
9. `libtrn/scorefile.cpp`, `sf_append`
...
11. `libtrn/univ.cpp`, `univ_use_file`

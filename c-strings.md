...
3. `libtrn/kfile.cpp`, `do_kill_file`
...
4. `libtrn/kfile.cpp`, `edit_kill_file`
...
5. `libtrn/scorefile.cpp`, `sf_get_extra_header`
...
6. `libtrn/search.cpp`, `CompiledRegex::compile`
...
7. `libtrn/util.cpp`, `secs_to_text`
...
8. `libtrn/cache.cpp`, `fetch_cache`
...
9. `libtrn/head.cpp`, `prefetch_lines`

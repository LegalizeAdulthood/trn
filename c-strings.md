...
1. `libtrn/kfile.cpp`, `do_kill_file`
...
2. `libtrn/kfile.cpp`, `edit_kill_file`
...
3. `libtrn/scorefile.cpp`, `sf_get_extra_header`
...
4. `libtrn/search.cpp`, `CompiledRegex::compile`
...
5. `libtrn/util.cpp`, `secs_to_text`
...
6. `libtrn/cache.cpp`, `fetch_cache`
...
7. `libtrn/head.cpp`, `prefetch_lines`

...
1. `libtrn/kfile.cpp`, `edit_kill_file`
...
2. `libtrn/scorefile.cpp`, `sf_get_extra_header`
...
3. `libtrn/search.cpp`, `CompiledRegex::compile`
...
4. `libtrn/util.cpp`, `secs_to_text`
...
5. `libtrn/cache.cpp`, `fetch_cache`
...
6. `libtrn/head.cpp`, `prefetch_lines`
